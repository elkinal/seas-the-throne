...
public class BossController {
  ...
  /**
   * If in IDLE: switches to MOVE if time limit is reached, while also setting a
   * new target and velocity
   * based on that target.
   *
   * If in MOVE: switches to IDLE if time limit is reached or close to target,
   * while setting velocity to 0.
   */
