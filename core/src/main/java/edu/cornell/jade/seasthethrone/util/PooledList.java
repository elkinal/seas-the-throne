 ...
 *
 * <p>This class supports O(1) deletion for internal nodes. Simply use the entryIterator() method to
...
public class PooledList<E> extends AbstractSequentialList<E> implements Iterable<E> {
  ...
  public class Entry implements Pool.Poolable {
     ...
     *
     * <p>This method supports O(1) deletion.
     */
    public void remove() {
      if (prev != null) {
        prev.next = next;
   ...
   *
   * <p>This class does no preallocate, but will reuse objects that have been freed.
   */
  private class EntryPool extends Pool<Entry> {
     ...
     *
     * <p>This method allocates a new object if there are no free ones.
     *
     * @return a new entry object
     */
   ...
   *
   * <p>All elements after index are shifted one element to the right.
   *
  ...
  private class ValueIterator implements ListIterator<E> {
     ...
     *
     * <p>The element is inserted before the next position
     *
