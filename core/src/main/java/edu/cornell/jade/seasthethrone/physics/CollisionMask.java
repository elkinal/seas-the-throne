...
public class CollisionMask {
    ...
    private static final short CATEGORY_ENEMY_BULLET = 0x0002;

    /** Category bitmask for player bullet */
    private static final short CATEGORY_PLAYER_BULLET = 0x0004;

    /** Category bitmask for boss  */
    private static final short CATEGORY_BOSS = 0x0008;

    /** Category bitmask for wall  */
    private static final short CATEGORY_WALL = 0x0010;
    ...
    public static void setMaskBits(Model model){
