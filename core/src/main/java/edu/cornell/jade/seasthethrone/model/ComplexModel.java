...
public abstract class ComplexModel extends Model {
   ...
   */
  public Iterable<Model> getBodies() {
    return bodies;
  }
  ...
  public boolean isRemoved() {
    return (bodies.size > 0 && bodies.get(0).isRemoved());
  }
   ...
   */
  protected ComplexModel(float x, float y) {
    super(x, y);
    bodies = new Array<Model>();
