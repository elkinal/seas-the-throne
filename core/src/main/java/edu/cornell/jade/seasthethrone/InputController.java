...
//    /** List of all the AI opponent input controllers */
//    private ArrayList<AIController> opponents;
...
//        opponents = new ArrayList<>();
  ...
  private void readController(PlayerController obj) {
        ...
        obj.pressSecondary(xbox.getLeftTrigger() > 0.6f);
    }
