...
public class JsonHandler {
   ...
   *
   * <p>Currently all values are Objects
   *
  ...
  /**
   * Takes a root JsonValue representing a map and fills in the map with the fields of the
   * JsonValue.
   *
  ...
  /**
   * Finds the specified field in the specified map and returns its value. Assumes the value is an
   * integer.
   *
  ...
  /**
   * Finds the specified field in the specified map and returns its value. Assumes the value is a
   * float.
   *
   * @param map the JSON map containing the desired field
   * @param fieldName the name of the field in the map
   ...
   * @throws Exception if no field with fieldName is found in the map
   */
  public static Array<HashMap<String, Object>> getArray(
      HashMap<String, Object> map, String fieldName) {
    try {
