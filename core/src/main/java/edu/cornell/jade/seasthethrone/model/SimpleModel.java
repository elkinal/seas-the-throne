 ...
 *
 * <p>This is an instance of a Obstacle with just one body. It does not have any joints. It is the
 * primary type of physics object.
 *
 * <p>This class does not provide Shape information, and cannot be instantiated directly.
 */
public abstract class SimpleModel extends Model {
   ...
   *
   * <p>REMEMBER: The size is in physics units, not pixels.
   */
   ...
   */
  protected SimpleModel(float x, float y) {
    super(x, y);
    origin = new Vector2();
    body = null;
  }
